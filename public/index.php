...
function index_page(){
 ...
 '<div id="title">QRaidCODE</div>
  ...
  <div id="subtitle">IMPORTANT: this application is for demonstration purpose only. Do not use it for important or critical data. Few bugs could remain, it could not work as espected.</div>
