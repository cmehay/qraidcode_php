...
function html_about(){
 ...
 '<div id="title">About QRaidCODE</div>
  ...
  <div id="description">The data are packed in binary contener and crypted, and for the paraity it use the same Reed-Solomon algorythm involved in RAID6.</div>
