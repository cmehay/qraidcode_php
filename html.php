...
function html_about(){
 ...
 '<div id="about-title">About QRaidCODE</div>
  ...
  <div id="answer">QRaidCODE is a system allowing to write data on multiple Qrcodes with parity which allows you to decode your data with a fraction of the qrcodes generated.</div>
  <div id="question">How does it work?</div>
  <div id="answer">The data are packed and encrypted, the same Reed-Solomon algorythm involved in RAID6 is used for the parity system.</div>
  <div id="question">Is this secure?</div>
  <div id="answer">Yep, the data are encrypted and the encryption key is distributed on the Qrcodes. If someone found one of the qrcode, he will not be able to read the content, 
			all qrcodes are required to get the data and the encryption key.</div>
  <div id="question">How should I use the parity system?</div>
  <div id="answer">The parity system allows you to get more qrcodes than needed to decode your data. For instance, if you generate 10 qrcodes with data and 4 qrcodes with parities, 
  ...
  <div id="answer">Not yet, but I am working on a javascript porting which will be under a Free licence and Opensource.</div>
  <div id="question">Can I use another qrcode reader to read the qrcodes?</div>
  <div id="answer">Nope, you can read the qrcodes with any reader, but you will not be able to decode them.</div>
  <div id="question">How many qrcodes can I create?</div>
  <div id="answer">The Reed-Solomon algorythm used in QRaidCODE can compute up to 256 qrcodes, but for performance issue, this demo allows you to create 150 qrcodes max. 
  ...
  <div id="answer">You do well in speaking of it. I would like to thank <a href="http://web.eecs.utk.edu/~plank/">James S. Plank</a> for his papers on Galois fields and Reed-Solomon algorythm, 
  ...
  <div id="answer">I will publish more informations about this project on <a href="https://goldy.furry.fr/">my blog</a>.</div>
  
  <div id="answer">Please donate bitcoins to support this project if you like it : 1<span class="bold">Go1dy</span>1GRBAHbPUTu6xPaWPSqQPd4DzU2i</div>
  ' ;
}
