...
function html_about(){
 ...
 '<div id="about-title">About QRaidCODE</div>
  ...
  <div id="description">The parity system allows you to get more qrcodes than needed to decode your data. For instance, if you generate 10 qrcodes with data and 4 qrcodes with parities, 
  ...
  <div id="description">Nope, you can read the qrcodes with any reader, but you will not be able to decode them.</div>
  <div id="question">How many qrcodes can I create?</div>
  <div id="description">The Reed-Solomon algorythm used in QRaidCODE can compute up to 256 qrcodes, but for performance issue, this demo allows you to create 150 qrcodes max. 
  ...
  <div id="description">I will publish more informations about this project on <a href="https://goldy.furry.fr/">my blog</a>.</div>
